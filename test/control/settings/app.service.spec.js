describe('Unit : skinIndexPluginSettings design services', function () {


    describe('Unit : DataStore Factory', function () {
        var DataStore, Buildfire, $rootScope, TAG_NAMES, STATUS_MESSAGES, STATUS_CODE, q;
        beforeEach(module('skinIndexPluginSettings', function ($provide) {
        ...
        it('DataStore.save should called with success', function () {
            ...
            DataStore.save(TAG_NAMES.UVO_INFO,item).then(success, error);
        });
